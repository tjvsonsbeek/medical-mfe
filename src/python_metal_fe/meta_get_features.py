    ...
    for task_id, task in enumerate(tasks_list):
        for fe in feature_extractors:
            ...
            if subset_size in custom_subset_size.keys():
                if task in subset_size[subset_size].keys():
                    subset_size = subset_size[subset_size][task]
